...
if(isset($_GET['inputDeleteUsername']) && !empty($_GET['inputDeleteUsername'])){
    $username= mysql_fix_string(trim($_GET['inputDeleteUsername']));
    $query .="MATCH(username) AGAINST('{$username}') ORDER BY username";
  }elseif($_GET['inputDeleteUsername']==""){
