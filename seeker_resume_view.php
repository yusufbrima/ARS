...
if(!empty($user_id)){
  ...
  if($num_row>0){
    for($i=0;$i<$num_row;$i++){
      ...
      $img = "<a title='Update your profile picture' href='seeker_picture_update.php?seeker_id={$seeker['id']}&user_id={$user_id}'><img src='{$path}' alt='Profile Picture' class='img-circle' /></a>";
      $seeker_profile ="<div class='container'><table border='0'>";
      $seeker_profile .="<tr><td class='profile_title'>Salutation</td><td>{$seeker['sex']}</td><td><a title='Edit your profile' href='seeker_profile_update.php?seeker_id={$seeker['id']}&user_id={$user_id}'><span class='glyphicon glyphicon-edit'></span> Edit</a></td></tr>";
      ...
      $affected_rows 	= mysqli_num_rows($education_result);
       if($affected_rows>0){
        ...
        for($i=0;$i<$affected_rows;$i++){
          ...
          $seeker_education .="<td>{$row['end_date']} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='seeker_education_update.php?education_id={$row['id']}&user_id={$seeker_id}'><span class='glyphicon glyphicon-edit'></span></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href='#' data-toggle='modal' data-href='seeker_resume_view.php?education_id={$row['id']}&user_id={$seeker_id}' data-target='#seeker_education'><span class='glyphicon glyphicon-trash'></span></a></td></tr>";
        }
        $seeker_education .="<tr><td><a href='seeker_education.php'><span class='glyphicon glyphicon-plus'></span> Add</a></td></tr>";
      ...
      if($affected_ex_rows>0){
       ...
       for($i=0;$i<$affected_ex_rows;$i++){
         ...
         $seeker_experience .="<td>{$row['end_date']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='seeker_experience_update.php?experience_id={$row['id']}&user_id={$seeker_id}'><span class='glyphicon glyphicon-edit'></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='#' data-toggle='modal' data-href='seeker_resume_view.php?exp_id={$exp_id}&user_id={$seeker_id}' data-target='#experience_delete'><span class='glyphicon glyphicon-trash'></span></a></td></tr>";
       }
       $seeker_experience .="<tr><td><a href='seeker_experience.php'><span class='glyphicon glyphicon-plus'></span> Add</a></td></tr>";
       ...
       if($affected_skills_rows>0){
        ...
        for($i=0;$i<$affected_skills_rows;$i++){
          ...
          $seeker_skills .="<td>{$row['other_skill']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='seeker_skills_update.php?skill_id={$row['id']}&user_id={$seeker_id}'><span class='glyphicon glyphicon-edit'></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='#' data-href='seeker_resume_view.php?skill_id={$skill_id}&user_id={$seeker_id}' data-toggle='modal' data-target='#skill_delete'><span class='glyphicon glyphicon-trash'></span></a></td></tr>";
        }
        $seeker_skills .="<tr><td><a href='seeker_skills.php'><span class='glyphicon glyphicon-plus'></span> Add</a></td></tr>";
      ...
      if($affected_ref_rows>0){
       ...
       for($i=0;$i<$affected_ref_rows;$i++){
         ...
         $seeker_reference .="<td><span class='glyphicon glyphicon-phone-alt'></span> {$row['phone']} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='seeker_reference_update.php?reference_id={$row['id']}&user_id={$seeker_id}'><span class='glyphicon glyphicon-edit'></span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='#' data-href='seeker_resume_view.php?ref_id={$ref_id}&user_id={$seeker_id}' data-toggle='modal' data-target='#reference_delete'><span class='glyphicon glyphicon-trash ref'></span></a></td></tr>";
       }
       $seeker_reference .="<tr><td><a href='seeker_references.php'><span class='glyphicon glyphicon-plus'></span> Add</a></td></tr>";
  ...
  <body>
     ...
     <div class="clear-fix clear-top"></div>
       ...
       <div class="container resume_img">
            <em class="h1">My Resume</em><hr /><br />
              ...
              <?php if($flag['education']){
                ...
                echo "<a href='seeker_education.php'><span class='glyphicon glyphicon-plus'></span> Add Education Background</a>";
              }
              ?>
              <hr />
            ...
            <?php if($flag['experience']){
              ...
              echo "<a href='seeker_experience.php'><span class='glyphicon glyphicon-plus'></span> Add Your previous work experience</a>";
            }
            ?>
            <hr />
          ...
          <?php if($flag['skills']){
            ...
            echo "<a href='seeker_skills.php'><span class='glyphicon glyphicon-plus'></span> Add Your acquired skillsets</a>";
          }
          ?>
          <hr />
        ...
        <?php if($flag['reference']){
          ...
          echo "<a href='seeker_references.php'><span class='glyphicon glyphicon-plus'></span> Add Your References</a>";
        }
        ?>
     </div><!--End of Container Div-->
       <?php include_once "footer.php"; ?><!--Site footer-->
 <?php include "library.php"; ?><!--Script Library files -->
   <?php include_once "seeker_reference_delete.php"; ?><!--Seeker reference modal-->
   <?php include_once "seeker_education_delete.php"; ?><!--seeker education modal-->
   <?php include_once "seeker_skills_delete.php"; ?><!--seeker skills modal-->
   <?php include_once "seeker_experience_delete.php"; ?><!--seeker experience modal-->
 </body>
 <script>
     $('#reference_delete').on('show.bs.modal', function(e) {
     $(this).find('.btn-ok').attr('href', $(e.relatedTarget).data('href'));
     });
     $('#skill_delete').on('show.bs.modal', function(e) {
     $(this).find('.btn-ok').attr('href', $(e.relatedTarget).data('href'));
     });
     $('#experience_delete').on('show.bs.modal', function(e) {
     $(this).find('.btn-ok').attr('href', $(e.relatedTarget).data('href'));
     });
     $('#seeker_education').on('show.bs.modal', function(e) {
     $(this).find('.btn-ok').attr('href', $(e.relatedTarget).data('href'));
     });
 </script>
 </html>
