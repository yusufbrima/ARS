       ...
       <div class="container">
          <div class="col-md-6">
              <form method="post" action="<?php outputData($_SERVER['PHP_SELF']); ?>" name="frmSeekerExperience" id="frmSeekerExperience">
                <fieldset>
                  <legend class="legend"><img src="images/privious_experience.png" alt="Previous working experience" /></legend>
                  <div class="form-group">
                    <label for="inputJobTitle" >Job Title<em class="required">*</em></label>
                    <input class="form-control" type="text" value="<?php if(isset($_POST['inputJobTitle'])){echo $_POST['inputJobTitle']; }?>"name="inputJobTitle" id="inputJobTitle"
                      placeholder="Enter Job Title"   />
                  </div>
                  <div class="form-group">
                    <label for="inputOrganization" >Organization Name<em class="required">*</em></label>
                    <input class="form-control" type="text" value="<?php if(isset($_POST['inputOrganization'])){echo $_POST['inputOrganization']; }?>"name="inputOrganization" id="inputOrganization"
                              ...
                              if(isset($_POST['inputOccupationalField']) && !empty($_POST['inputOccupationalField'])){
                                if(isset($_POST['inputCareerField']) && !empty($_POST['inputCareerField'])){
                                  if(isset($_POST['inputStartDate']) && !empty($_POST['inputStartDate'])){
                                    ...
                                    if(add_seeker_experience($con, $job_title, $organization_name,$occupational_field,$field_of_study,$start_date,$end_date,$seeker_id)){
