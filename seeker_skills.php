       ...
       <div class="container">
          <div class="col-md-6">
              <form method="post" action="<?php outputData($_SERVER['PHP_SELF']); ?>" name="frmSeekerSkills" id="frmSeekerSkills">
                <fieldset>
                  <legend class="legend"><img src="images/seeker_skills.png" alt="Previous working experience" /></legend>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="inputComputerSkill" class="form-control" value="<?php if(isset($_POST['inputComputerSkill'])){echo $_POST['inputComputerSkill']; }?>" placeholder="List your Computer Skills"   autocomplete="on"/>
                  </div>
                  <div class="form-group">
                    <label for="inputLeadershipSkill" >Leadership Skills<em class="required">*</em></label>
                    <textarea cols="10" rows="4" name="inputLeadershipSkill" class="form-control" style="text-align:left;">
                    </textarea>
                  </div>
                  <div class="form-group">
                    <label for="inputInterest" >Special Interests list if any e.g, Reading!<em class="required">*</em></label>
                    <input type="text"  name="inputInterest" class="form-control" value="<?php if(isset($_POST['inputInterest'])){echo $_POST['inputInterest']; }?>" placeholder="Enter your special interests"/>
                  </div>
                  <div class="form-group">
                              ...
                              if(isset($_POST['inputComputerSkill']) && !empty($_POST['inputComputerSkill'])){
                                if(isset($_POST['inputLeadershipSkill']) && !empty($_POST['inputLeadershipSkill'])){
                                  if(isset($_POST['inputInterest']) && !empty($_POST['inputInterest'])){
                                    ...
                                    if(add_seeker_skills($con, $languages, $computer_skills,$leadership_skills,$special_interest,$other_skills,$seeker_id)){
